...
namespace CapaPresentacion
{
    public partial class FrmMadre : Form
    {
        ...
        public FrmMadre()
        {
            ...
            this.toolTip1.SetToolTip(this.textBox16, "ingrese el Domicilio ");
        ...
        {
            this.dataGridView1.DataSource = NMadre.Mostrar();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (this.isnuevo)
                    {
                        rpta = NMadre.Insertar(textBox2.Text, textBox31.Text, textBox33.Text, textBox20.Text, textBox25.Text, textBox32.Text,
      textBox24.Text, textBox21.Text, textBox1.Text, textBox16.Text,
       (textBox5.Text), dateTimePicker2.Value, textBox28.Text, comboBox2.Text, comboBox1.Text);
                    }
                    else
                    {
                        rpta = NMadre.Editar(Convert.ToInt32(this.textBox3.Text), textBox2.Text, textBox31.Text, textBox33.Text, textBox20.Text, textBox25.Text, textBox32.Text,
      textBox24.Text, textBox21.Text, textBox1.Text, textBox16.Text,
      (textBox5.Text), dateTimePicker2.Value, textBox28.Text, comboBox2.Text, comboBox1.Text);
                    }
        ...
        {
            this.textBox3.Text = Convert.ToString(this.dataGridView1.CurrentRow.Cells["id_madre"].Value);
            ...
            this.textBox16.Text = Convert.ToString(this.dataGridView1.CurrentRow.Cells["Domicilio Actual"].Value);
